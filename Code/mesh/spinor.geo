...
ds = 0.9;                                                       // Setting side discretization length...
x_min = -0.9;                                                   // Setting "x_min"...
x_max = +0.9;                                                   // Setting "x_max"...
y_min = -0.9;                                                   // Setting "y_min"...
y_max = +0.9;                                                   // Setting "y_max"...
z_min = -0.9;                                                   // Setting "y_min"...
z_max = +0.9;                                                   // Setting "y_max"...
